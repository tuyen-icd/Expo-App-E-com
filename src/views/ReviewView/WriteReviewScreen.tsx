...
import { API_ADD_REVIEW } from '../../configs'
...
const WriteReviewScreen: FC<WriteReviewScreen> = ({ route }) => {
    ...
    console.log('data_WriteReviewScreen :>> ', data);
    ...
    const handleSendReview = () => {
        ...
        axios.post('https://dummyjson.com/comments/add', bodyDataReview, {
            headers: {
        ...
        <View style={{ backgroundColor: AppEComm.color.white, flex: 1 }}>
            ...
            <View style={{ paddingHorizontal: widthPixel(16) }}>
                ...
                <ScrollView horizontal={true} style={{ flex: 0, flexDirection: "row", }}>
                    <TouchableOpacity onPress={() => setIsShowModal(true)} style={{ paddingTop: heightPixel(12), marginBottom: heightPixel(50) }}>
                        <ICAddCamera />
                    </TouchableOpacity>
                </ScrollView>
                <ModalCamera
